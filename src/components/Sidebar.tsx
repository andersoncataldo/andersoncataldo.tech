  ...
  const SidebarContent = ({ isMobile = false }: { isMobile?: boolean }) => (
    <>
      <div>
        <div className="flex items-center justify-between gap-3 border-b border-white/10 px-5 py-5">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-3xl bg-white/10 text-apple-blue text-lg font-bold">A</div>
            {!collapsed && (
              <div>
        ...
        <div className="border-b border-white/10 px-5 py-5">
          ...
          {searchOpen && !collapsed && (
            <div className="mt-4 rounded-3xl border border-white/10 bg-white/5 p-3">
              <label htmlFor={isMobile ? 'sidebar-search-mobile' : 'sidebar-search'} className="sr-only">
                Buscar navegação
              </label>
              <input
                id={isMobile ? 'sidebar-search-mobile' : 'sidebar-search'}
                ref={searchInputRef}
                value={searchQuery}
      ...
      <div className="border-t border-white/10 px-5 py-5">
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-3xl bg-white text-apple-blue text-lg font-bold">A</div>
          {!collapsed && (
            <div>
